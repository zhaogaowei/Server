...
public:
	...
	size_t readableBytes() { return _writeIndex - _readIndex; }
	size_t writableBytes() { return _buffer.size() - _writeIndex; }
	...
	char* peek() { return const_cast<char*>(begin()) + _readIndex; }
